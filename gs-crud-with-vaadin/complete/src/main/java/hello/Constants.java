...
public class Constants {
    ...
    public static final Long USER_NOT_LOGGED_IN_EC=106L ;
    public static final String USER_NOT_LOGGED_IN_EM = "User {%s} not logged in. Please login in before using the system.";
